...
export const BAGELS : Bagel[] = [
        ...
        {name: "Cinnamon Raisin", price: 5.00, imageLocation: "../assets/imgs/CinnamonRaisin.jpg", description: "What, these aren't chocolate chips?"},
        ...
        {name: "Pretzel", price: 5.00, imageLocation: "../assets/imgs/Pretzel.jpg", description: "Bester bagel überhaupt."}];
